$(document).ready(function() {
		    ...
		    $.ajax({
		        url: 'http://localhost:9092/cart_shop/AllProductsServlet',
		        method: 'GET',
...
$(document).ready(function() {
			var url = 'http://localhost:9092/cart_shop/CategoriesServlet';
		    $.ajax({
		        url: url,
		        method: 'GET',
		        success: function(data) {
...
$(document).on('change', '#category', function() {
					...
					console.log(scv)
				     $.ajax({
				        url: 'http://localhost:9092/cart_shop/AllProdByIdServlet',
				        method: 'GET',
						data: {val:scv},
				    success: function(data) {
		            $('.row').empty();
